...
const dictionaries = {
  es: {
    ...
    categoryNames: ["Mesa", "Hogar", "Bienestar"],
    mainNavLabel: "Navegaci\u00f3n principal",
    heroArtLabel: "Composici\u00f3n editorial de producto",
    edition: "Edici\u00f3n Nexautia",
  ...
  ca: {
    ...
    categoryNames: ["Taula", "Llar", "Benestar"],
    mainNavLabel: "Navegaci\u00f3 principal",
    heroArtLabel: "Composici\u00f3 editorial de producte",
    edition: "Edici\u00f3 Nexautia",
